...
export default async function AccountsPage() {
  ...
  const cookieStore = await cookies() // still needed for Payload auth
  ...
  const isClientRole = isClient(activeRole)
  ...
  // Collectors / court agents dropdowns
  let collectors: any[] = []
